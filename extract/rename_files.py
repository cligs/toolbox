...
def rename_files(wdir, inpath, metadatafile, primary_category, secondary_category):
    ...
    Example of how to use it: rename_files("/home/jose/cligs/ne/subset_df/", "txt/*.txt", "metadata_obl.csv", "author-name", "title")
...
def main(wdir, fullset, metadata, outfolder):
    rename_files(wdir, fullset, metadata, outfolder)
