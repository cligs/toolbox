...
# 1. Modify the path to the working directory; create an empty "output" folder.
...
#   textonly = re.sub(r'\n\n',"\n",textonly)             # Removes some of the unnecessary newlines (do twice if useful)    
    txtoutput = "./output/" + filename[:-4] + ".txt"     # Builds filename for outputfile from original filenames.
