...
def transnomino(file,metadatafile):
    ...
    newfilename = "txt120_author-decade-title/" + author +"_"+ decade + "-"+ stitle +".xml"                   # Constructs the new filename. Adjust this as needed. 
...
main("./txt120/*.txt","polar.csv") 								# USER: Enter absolute or relative path to folder with files, define pattern for filename (e.g., extension), enter path for metadata file.
