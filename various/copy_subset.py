...
def copy_subset(fullset,metadata):
    ...
    #print(metadata)
    filtered = metadata[metadata.date < 1701 ]              # Sample data: ca. 1700-1800.
    filtered = filtered[filtered.genre == "Comedie"]        # Sample data: comedy, tragedy, other.
    filtered = filtered[filtered.form == "verse"]           # Sample data: prose, verse, mixed.
    filtered = filtered[filtered.author == "LafontaineJ"]    # Sample data: AlainR, AllainvalA, Andrieux, Anonyme, etc.
    #print(filtered)
    subset = []
